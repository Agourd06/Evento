                        ...
                        @foreach ($organizers as $organizer)
                            <tr class="even:bg-blue-50">
                                <td class="md:text-[15px] max-w-1  text-[12px]">
                                    <img class="w-full" src="{{ asset('storage/image/' .  $organizer->user->profile ) }}" alt="">
            ...
            <div class="overflow-x-auto">
                <table id="clientTable" class="min-w-full bg-white font-[sans-serif]">
                    ...
                    <tbody class="whitespace-nowrap">
                        ...
                        <tr class="even:bg-blue-50">
                            <td class="md:text-[15px] max-w-1  text-[12px]">
                                <img class="w-full" src="{{ asset('storage/image/' . $client->user->profile) }}" alt="">
