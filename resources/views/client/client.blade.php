...
<body>
    ...
    <div class="container shadow-lg mx-auto bg-white mt-24 md:mt-18 px-4 pt-6">
            ...
            <div class="flex flex-col">
                <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-lg">
                    <div class="w-full text-center font-bold text-2xl ">
                        <h1
                            class="bg-gradient-to-r from-[#44BCFF] via-[#FF44EC] to-[#FF675E] inline-block text-transparent bg-clip-text">
                            Found Your Desire</h1>
                    </div>
                    <form class="" action="/client" method="GET">
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                            <div class="relative  w-full flex  items-end justify-between rounded-md">
                                <svg class="absolute left-2 md:top-[55%] top-1/3 block h-5 w-5 text-gray-400"
                    ...
                    <div class="relative mx-auto w-full">
                        <div href="#"
                            ...
                            <div class="shadow p-4 rounded-lg bg-white">
                                ...
                                <div class="grid grid-cols-2 mt-8 gap-10 w-full">
                                    <div onclick="toggleModal('eventData{{ $event->id }}')"
                                        class="flex items-center w-full justify-center transitiona-all hover:text-white duration-1000  opacity-70 rounded-lg hover:bg-gradient-to-r from-[#44BCFF] via-[#FF44EC] to-[#FF675E] group-hover:duration-200">
                                        <a href="#" class="px-4 py-2">See More</a>
                                    </div>
                                    <div>
                        ...
                        <div class="flex h-screen items-center justify-center px-10">
                            <div class="w-full sm:w-1/2  bg-white shadow-xl rounded-3xl">
                                ...
                                <div class="flex justify-center gap-4 p-5">
                                    <button onclick="toggleModal('eventData{{ $event->id }}')"
                                        class="py-3 bg-indigo-500 font-semibold text-white w-1/4 rounded-xl hover:bg-indigo-600">Close</button>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        @else
            <div class="w-full text-2xl font-semibold pb-8 pt-4 text-center">
                <h1>No Events Found</h1>
            </div>
        @endif
        <div class="flex justify-center gap-4">{{ $events->links() }}
        </div>
    </div>
