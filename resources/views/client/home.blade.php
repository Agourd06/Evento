    ...
    <div class="container shadow-lg mx-auto bg-white mt-20  md:mt-18">
        ...
        <div class="relative w-full ">
            <video class="w-full h-screen object-cover " autoplay loop muted>
                <source src="{{ asset('storage/image/' . 'home.mp4') }}" type="video/mp4">
        ...
        <div class="font-[sans-serif] text-white bg-gradient-to-r from-purple-800/50 to-indigo-800/80 py-12 px-4">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-12 max-md:max-w-lg mx-auto">
                    <div
                        class="rounded-xl group p-8 text-center hover:bg-white hover:text-purple-800 hover:shadow-xl transition duration-300">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-8 mb-4 inline-block"
                            viewBox="0 0 32 32">
                            <path
                        ...
                        <p class="text-gray-300 group-hover:text-gray-500 text-sm">Tailor our product to suit your
                            needs.</p>
                    </div>
                    <div
                        class="rounded-xl group p-8 text-center hover:bg-white hover:text-purple-800 hover:shadow-xl transition duration-300">
                        ...
                        <p class="text-gray-300 group-hover:text-gray-500 text-sm">Your data is protected by the latest
                            security measures.</p>
                    </div>
                    <div
                        class="rounded-xl group p-8 text-center hover:bg-white hover:text-purple-800 hover:shadow-xl transition duration-300">
                        ...
                        <p class="text-gray-300 group-hover:text-gray-500 text-sm">24/7 customer support for all your
                            inquiries.</p>
                    </div>
                    <div
                        class="rounded-xl group p-8 text-center hover:bg-white hover:text-purple-800 hover:shadow-xl transition duration-300">
                        ...
                        <p class="text-gray-300 group-hover:text-gray-500 text-sm">Experience blazing-fast performance
                            with our product.</p>
                    </div>
                    <div
                        class="rounded-xl group p-8 text-center hover:bg-white hover:text-purple-800 hover:shadow-xl transition duration-300">
                        ...
                        <p class="text-gray-300 group-hover:text-gray-500 text-sm">Expand your reach with our global
                            network.</p>
                    </div>
                    <div
                        class="rounded-xl group p-8 text-center hover:bg-white hover:text-purple-800 hover:shadow-xl transition duration-300">
                        ...
                        <p class="text-gray-300 group-hover:text-gray-500 text-sm">Seamless communication for your
                            team.</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="font-[sans-serif] text-[#333] mt-4">
                        ...
                        <div class="py-4">
                            ...
                            <div class="space-x-4 mt-4">
                                <button type="button"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="12px" fill="#333"
                                ...
                                <button type="button"
                                    class="w-7 h-7 inline-flex items-center justify-center rounded-full border-none outline-none  bg-gray-100 hover:bg-gray-200">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="14px" fill="#333"
                                        viewBox="0 0 24 24">
                                        <path
