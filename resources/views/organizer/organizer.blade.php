                ...
                <form action="/createEvent" method="POST" id="booking" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="location" id="name"
                            placeholder="Enter Event Adress Here ..."
                            class="w-full rounded-md border border-[#e0e0e0] bg-white py-2 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                        ...
                        <div class="w-full">
                            ...
                            <div class="w-full pr-3 ">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="price" id="price" placeholder="Chair Price"
                                        class="w-full rounded-md border border-[#e0e0e0] bg-white py-2 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                </div>
                    ...
                    <div class=" w-full grid grid-cols-2 ">
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" name="sets" id="price" placeholder="Sets Number ..."
                                class="w-full rounded-md border border-[#e0e0e0] bg-white py-2 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                        </div>
                    </div>
                    <div class="mb-7">
