...
<body>
    ...
    <div class="container shadow-lg mx-auto bg-white mt-24 md:mt-18 ">
        ...
        @if ($reservations->count() > 0)
                    ...
                    <div class="mb-8 border border-gray-100 border-solid ">
                        <div class=" w-full pb-4  rounded-md shadow-lg">
                            <div class=" ">
                                ...
                                <img src="{{ asset('storage/image/' . $reservation->event->image) }}" alt=""
                            ...
                            <div class="grid grid-cols-2 grid-rows-2 gap-4 mt-8 px-4 overflow-hidden">
                                ...
                                <p class="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
                                    ...
                                    <span class="mt-2 xl:mt-0 ml-2">{{ $reservation->client->user->first_name }}
                                        {{ $reservation->client->user->last_name }}
                        ...
                        <div class="flex ">
                            <form action="/AcceptReservation/{{ $reservation->id }}/{{ $reservation->event->id }}"
            ...
            @else
            <div class="w-full text-2xl font-semibold py-8 text-center">
                <h1>No Reservations Demand Found</h1>
            </div>
            @endif
    </div>
    <script>
